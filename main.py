...
def main():
	...
	dp.add_handler(CommandHandler('sdidattica',sdidattica))
	dp.add_handler(CommandHandler('sstudenti',sstudenti))
	dp.add_handler(CommandHandler('cea',cea))
	dp.add_handler(CommandHandler('ersu',ersu))
	dp.add_handler(CommandHandler('ufficioersu',ufficioersu))
	dp.add_handler(CommandHandler('urp',urp))
