...
* Rename file "data/DMI_DB.db.dist" to "data/DMI_DB.db" to enable the database sqlite
* Rename file "config/settings.yaml.dist" to "config/settings.yaml" (If you don't have a token, message Telegram's [@BotFather](http://telegram.me/Botfather) to create a bot and get a token for it)
